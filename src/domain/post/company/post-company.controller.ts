...
export class PostCompanyController {
    ...
    async getListSite(
        ...
        @Query() query: PostCompanyGetListSiteRequest,
    ): Promise<BaseResponse<PostCompanyGetListSiteResponse>> {
        return BaseResponse.of(await this.postCompanyService.getListSite(req.user.accountId, siteId, query));
    }
    ...
    async getListApplication(
        @Req() request: BaseRequest,
        @Query() query: PostCompanyGetListApplicationRequest,
